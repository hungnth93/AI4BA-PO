...
Copy **toàn bộ** nội dung từ `../project-context-template.md` sang `{output_folder}/project-context.md` (đã có sẵn §1–§10 và baseline rule). Khởi tạo/ghi frontmatter (`project_name`, `user_name`, `date`, …). Không dùng bản rút gọn khác — đây là skeleton duy nhất.
